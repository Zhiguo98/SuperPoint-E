...
class EndoMapper(data.Dataset):
    ...
    def __init__(self, export=False, transform=None, task='train', **config):
        ...
        # get files
        base_path = Path(DATA_PATH, 'UZ/training/training_colmap_frames_256')# + task + '2014/')
    ...
    def __getitem__(self, index):
        ...
        def _read_image(path):
            ...
            input_image = input_image[y_offset:y_offset+self.sizer[0],x_offset:x_offset+self.sizer[1]]#cv2.resize(input_image, (self.sizer[1], self.sizer[0]),
