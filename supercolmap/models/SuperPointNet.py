...
import sys
sys.path.append("/Users/zhiguoma/Desktop/master/homework/image_understanding/final/SuperPointTrackingAdaptation/supercolmap/utils/utils.py")
...
class SuperPointNet(nn.Module):
    ...
    def forward(self, data):
        ...
        Output
            ...
            desc: Output descriptor pytorch tensor shaped N x 256 x H/8 x W/8.
        """
        # print("Input image size1:", data['image'].shape)
        # Shared Encoder.
