...
def matches_extraction(path_images, path_results, featuretype, sp_weights_path, matchtype, sg_weights_path):
    ...
    f.close()
    subprocess.run(['python3', '/Users/zhiguoma/Desktop/master/homework/image_understanding/final/SuperPointTrackingAdaptation/supercolmap/match_pairs.py',
...
if __name__ == "__main__":
    ...
    path_colmap = '/Users/zhiguoma/colmap/build/src/colmap/exe/colmap' #'/home/leon/repositories/colmap/build/src/exe/colmap'  # 'COLMAP.app/Contents/MacOS/colmap'
    ...
    path_images = '/Users/zhiguoma/Desktop/master/homework/image_understanding/dataset/' + video + '/' + cluster
    if args.reperror != '4':
        path_results = '/Users/zhiguoma/Desktop/master/homework/image_understanding/result/' + model + '/' + video + '_err' + args.reperror + '/' + cluster
    else:
        path_results = '/Users/zhiguoma/Desktop/master/homework/image_understanding/result/' + model + '/' + video + '/' + cluster  # + '_err' + args.reperror
